...
- One **green** action per screen (`.goBtn` / `BigActionButton`): DEPLOY, START MATCH, ENTER LOBBY, NEXT MAP, PLAY. Everything else is the quiet navy button. Gold is for values and titles, not for buttons.
