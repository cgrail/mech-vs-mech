...
Every overlay screen — the lobby, the mission menu, the level select, the end
screen — is one column of titled cards over the orbiting map preview, with the
title bar and the single green action button pinned outside the scroll
